...
die Nachbearbeitung verwendete Werkzeug, beschädigt werden.
...
\begin{itemize}
    \item \textbf{Aufnahme der Scandaten}\\
        ...
        Verschiebung im Schraubstock durch einen Verschiebungsmesser aufgezeichnet werden.
    ...
    \item \textbf{Deformationserkennung}\\
        Wenn ein zusammengefügtes Bild für ein eingespanntes Bauteil vorliegt, sollen verschiedene 
        Zustände des Bauteils verglichen werden. Deformationen können erkannt werden, in dem 
        die Länge und Breite des Bauteils verglichen wird. Es sollen verschiedene
        ...
        soll visuell ausgegeben und gespeichert werden.
