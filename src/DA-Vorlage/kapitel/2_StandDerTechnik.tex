...
Additive Fertigung (AF), unabhängig von dem Werkstoff, ist ein Bereich in dem viel
...
\cite{inproceedings}
Einige dieser Limitierungen können umgangen oder gelöst werden. Zum Beispiel kann die
verminderte Oberflächenqualität kann durch eine anschließende Fräsbearbeitung
verbessert werden. 
[todo was sind supportstrukturen und warum braucht man sie]
...
\begin{figure}[H]
    ...
    \caption{Akkuranz der Fotogrammetrie}
...
Bauteile die breiter sind als die maximale Breite der Scanebene, in Abbildung \ref{fig:scanner} mittig 25 mm, 
...
[todo was ist eine Transformation]
